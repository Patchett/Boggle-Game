#############################################################################
# Makefile for building: pa4-rbridges
# Generated by qmake (3.0) (Qt 5.0.1) on: Sat Dec 6 17:44:55 2014
# Project:  pa4-rbridges.pro
# Template: app
# Command: /software/common/qt-5.0.1/bin/qmake -o Makefile pa4-rbridges.pro
#############################################################################
...
CXXFLAGS      = -pipe -std=c++11 -O2 -Wall -g -W -D_REENTRANT -fPIE $(DEFINES)
...
Makefile: pa4-rbridges.pro /software/common/qt-5.0.1/mkspecs/linux-g++/qmake.conf /software/common/qt-5.0.1/mkspecs/features/spec_pre.prf \
		/software/common/qt-5.0.1/mkspecs/common/shell-unix.conf \
		/software/common/qt-5.0.1/mkspecs/common/unix.conf \
		/software/common/qt-5.0.1/mkspecs/common/linux.conf \
		/software/common/qt-5.0.1/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) -o Makefile pa4-rbridges.pro
...
dist: 
	@test -d .tmp/pa4-rbridges1.0.0 || $(MKDIR) .tmp/pa4-rbridges1.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/pa4-rbridges1.0.0/ && $(COPY_FILE) --parents baseboggleplayer.h boggleboard.h boggleplayer.h boggleutil.h mainwindow.h ui_mainwindow.h ui_mainwindow.hpp .tmp/pa4-rbridges1.0.0/ && $(COPY_FILE) --parents boggleboard.cpp boggleplayer.cpp boggleutil.cpp main.cpp mainwindow.cpp .tmp/pa4-rbridges1.0.0/ && $(COPY_FILE) --parents mainwindow.ui .tmp/pa4-rbridges1.0.0/ && (cd `dirname .tmp/pa4-rbridges1.0.0` && $(TAR) pa4-rbridges1.0.0.tar pa4-rbridges1.0.0 && $(COMPRESS) pa4-rbridges1.0.0.tar) && $(MOVE) `dirname .tmp/pa4-rbridges1.0.0`/pa4-rbridges1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/pa4-rbridges1.0.0
